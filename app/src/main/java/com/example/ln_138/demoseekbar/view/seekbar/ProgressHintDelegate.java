...
public abstract class ProgressHintDelegate implements OnSeekBarChangeListener {
    ...
    protected TriangleRectangleTextView mPopupTextView;
    ...
    public static int PARTS_IN_HOUR = 60; // 60 means 1 minutes fraction between two  consecutive steps of seekbar
    ...
    public ProgressHintDelegate(SeekBar seekBar, AttributeSet attrs, int defStyleAttr) {
        ...
        //
        int mPopupLayout =
                a.getResourceId(R.styleable.ProgressHint_popupLayout, R.layout.popup);
    ...
    private void initDelegate(SeekBar seekBar, int mPopupLayout, int mPopupOffset,
        ...
        // set fraction of time to be selected
        mSeekBar.setMax((24 * PARTS_IN_HOUR) - 1);
    ...
    private void initHintPopup() {
        ...
        mPopupTextView.setText("12:00 AM");
        // init popup
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        int hours = progress / PARTS_IN_HOUR; // it will return hours.
        int minutes = (progress % PARTS_IN_HOUR); // here will be minutes.
        ...
        Log.d("PROGRESS : ", hours + " "+ meridiem);
        String time = hours + ":" + minutes +" "+ meridiem;
        mPopupTextView.setText(time);
